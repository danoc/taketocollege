  ...
  render() {
    return (
      <Container>
        ...
        <Helmet
          title={`What to Take to ${this.props.data.collegesJson.name}`}
          meta={[
            {
              property: "og:title",
              content: `What to Take to ${this.props.data.collegesJson.name}`
            },
          ...
          <script type="application/ld+json">
            {`
              ${JSON.stringify({
                ...
                name: `What to Take to ${this.props.data.collegesJson.name}`
              })}
            `}
          </script>
        </Helmet>
...
export const pageQuery = graphql`
  query CollegeByPath($name: String!) {
    site {
      siteMetadata {
        siteUrl
      }
